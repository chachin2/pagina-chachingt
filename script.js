...
function initSectorChips() {
    ...
    var titleEl = document.getElementById("sector-detail-title");
    var line1El = panel.querySelector(".sector-detail-line1");
    var line2El = panel.querySelector(".sector-detail-line2");
    var buttons = document.querySelectorAll(".sector-chip[data-line1]");
    if (!titleEl || !line1El || !line2El || !buttons.length) return;
    ...
    buttons.forEach(function (btn) {
        btn.addEventListener("click", function () {
            var bid = btn.id;
            if (lastOpenId === bid && !panel.hidden) {
                panel.hidden = true;
            ...
            lastOpenId = bid;
            var label = btn.querySelector(".sector-chip-label");
            titleEl.textContent = label ? label.textContent.trim() : "";
            line1El.textContent = btn.getAttribute("data-line1") || "";
            line2El.textContent = btn.getAttribute("data-line2") || "";
            panel.hidden = false;
...
/** Quita service workers antiguos (sitio web, no app instalable). */
...
document.querySelectorAll(".services-grid, .solutions-grid, .bento-grid").forEach((grid) => {
  grid.onmousemove = e => {
